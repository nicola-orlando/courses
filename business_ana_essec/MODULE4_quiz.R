...
# Original setup
Ebreak=predict(survreg, newdata=data, type="quantile", p=.01) # Make predictions based on the model. Here we estimate the median lifetime as the expected moment of "death"
...
orderActionsPriority=ActionsPriority[order(ActionsPriority$RemainingLT,decreasing = TRUE),]
View(orderActionsPriority) # View the output and take actions!
